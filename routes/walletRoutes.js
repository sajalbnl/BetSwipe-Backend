...
walletRouter.get('/:privyUserId', async (req, res) => {
    try {
...
walletRouter.post('/session/create', async (req, res) => {
    try {
...
walletRouter.get('/session/status/:privyUserId', async (req, res) => {
    try {
        const { privyUserId } = req.params;
...
walletRouter.delete('/session/:privyUserId', async (req, res) => {
    try {
        const { privyUserId } = req.params;
