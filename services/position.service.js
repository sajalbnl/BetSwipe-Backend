...
class PositionService {
     ...
     */
    async createOrUpdatePosition(params) {
     ...
     */
    async updatePositionPrices(privyUserId = null) {
        try {
            ...
            const updatePromises = positions.map(async (position) => {
                try {
                    ...
                    const priceData = await polymarketService.getMarketPrice(
                        position.marketId,
                        position.side
                    );
     ...
     * Get open positions
     */
    async getOpenPositions(privyUserId) {
        try {
     ...
     * Close position
     */
    async closePosition(positionId, closePrice, shares = null) {
        try {
